    ...
    <div className="relative min-h-screen flex items-center justify-center bg-slate-50 px-4 overflow-hidden">
      <div className="w-full max-w-md animate-fade-in z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-slate-500 mt-1">Ingresa a tu plataforma multi-agente No-Code</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-200 relative overflow-hidden">
          ...
          <div className="mt-8 text-center border-t border-slate-100 pt-6">
            <p className="text-xs text-slate-500">
              ¿No tienes cuenta?{' '}
              <Link href="/dashboard/register" className="text-[#0F766E] hover:text-[#0d645e] font-semibold transition-colors">
